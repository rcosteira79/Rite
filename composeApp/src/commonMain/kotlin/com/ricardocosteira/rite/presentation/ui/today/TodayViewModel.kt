...
class TodayViewModel(
    ...
    fun completeHabit(instanceId: String) {
        viewModelScope.launch {
            ...
            completeHabit.executeBinary(instanceId, CompletionSource.IN_APP)
                ...
                .onFailure {
                    _feedbackEvents.emit(TodayFeedbackEvent.ShowError(it.message))
                }
        }
    }
    ...
    fun deleteHabit(habitId: String) {
        ...
        viewModelScope.launch { _feedbackEvents.emit(TodayFeedbackEvent.HabitDeleted(habit.name)) }
    ...
    fun navigateToHabitDetail(instanceId: String) {
        viewModelScope.launch { _navEvents.emit(TodayNavEvent.ToHabitDetail(instanceId)) }
    }

    fun navigateToCreateHabit() {
        viewModelScope.launch { _navEvents.emit(TodayNavEvent.ToCreateHabit) }
    }
